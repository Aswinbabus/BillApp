...
<body>
 <a href="/" class="cart-btn ">&#8592;&nbsp;Back To Products</a>
    <div class="table-container">
        <h1 class="main-heading">Edit the Product Details</h1>
        <form:form action="updateProduct?oldCode=${product.pcode}" name="form" method="post" modelAttribute="product">
        ...
        <table cellpadding="10px" >
         ...
         <tr>
            ...
            <tr>
                ...
                <td><form:input path="price" min="0.01" required="required"/></td>
            </tr>
            <tr>
                <td class="index">Gst</td>
                <td><form:input path="gst" min="0.01" max="100.00" required="required"/></td>
            </tr>
            <tr>
